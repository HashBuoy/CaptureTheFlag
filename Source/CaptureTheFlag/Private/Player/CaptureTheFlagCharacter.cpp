...
void ACaptureTheFlagCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ACaptureTheFlagCharacter::Look);
...
void ACaptureTheFlagCharacter::DoMove(float Right, float Forward)
{
...
void ACaptureTheFlagCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ACaptureTheFlagCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ACaptureTheFlagCharacter::DoJumpEnd()
{
